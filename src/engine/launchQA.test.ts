...
describe('Phase 6 launch regression', () => {
  ...
  it('maintains broad Black-women representation libraries without ranking identities', () => {
    expect(characterTraits.ages.length).toBeGreaterThanOrEqual(8)
    expect(characterTraits.complexions.length).toBeGreaterThanOrEqual(12)
    expect(characterTraits.undertones.length).toBeGreaterThanOrEqual(8)
    expect(characterTraits.faces.length).toBeGreaterThanOrEqual(10)
    expect(characterTraits.noses.length).toBeGreaterThanOrEqual(10)
    expect(characterTraits.bodies.length).toBeGreaterThanOrEqual(12)
